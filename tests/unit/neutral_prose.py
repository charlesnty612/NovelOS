...
- **不触发** ``AI-DIALOGUE-ECHO``（2026-09-17 新增）：对白句排在**段首**且交替出现
  两条互不重复的句子（同一句相邻重复会被正确判为接词回声——那正是该规则要抓的
  灌水形状，故 fixture 必须避免机械重复）；
...
# 两句对白排在**偶数下标**上——每段两句（下标 (0,1)(2,3)(4,5)）⇒ 它们落在段首，
# 即 AI-DIALOGUE-ECHO 能看到它们；两句互不重复 ⇒ 相邻对白不成回声。
SENTENCES: tuple[str, ...] = (
    "“这袋盐先记在账上。”",
    "他站在柜台后头，把价签翻了个面。",
    "“账本我拿走一册。”",
