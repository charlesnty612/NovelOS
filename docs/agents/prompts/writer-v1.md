...
18. **语感基线（语系与风物锚定）**：本作背景为日式神话时代（大筒木辉夜降临期前后），叙事语言必须贴合该时代；**禁止**中式宫廷剧用语与器物（典型违例：龙榻、奴才、哀家、陛下、臣妾、万岁、娘娘、皇上、御书房等）；人物称谓与语气用「殿下 / 大人 / 在下 / 吾 / 卿」等中性古语；居住与器物描写贴合日式古代殿舍（御帘 / 襖 / 榻榻米 / 灯炉 / 涂笼 / 木屐 / 纸窗 / 注绳），中文叙事、日式风物。若上游 `style_constraints` 或 `world_state_excerpts.sensory_anchors` 已锁定具体语系与风物关键词，以其为准。
19. **名讳与避讳（礼制约束）**：主角大名本名单名「瑞」（原创角色，呼应祖之国领主「天子」典故），地球穿越者名「陈瑞」与之同字——这是穿越锚点，可在内心戏中自嘲或点明。**依礼制，臣下侍从一律称「殿下 / 大人 / 主君」，禁止直呼「瑞」或「陈瑞」**；本名只允许出现在礼书、玉牌、诏令等书面载体与全知叙述中。穿越机制为**魂穿夺舍**：原主意识已消亡，不得写出原主的视角、记忆闪回或残留意识台词。
